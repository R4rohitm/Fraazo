      ...
      <nav>
        <div>
          <ul class="w-full h-[88px] text-[#999999] font-Quicksand border container px-11 flex flex-wrap justify-between items-center mx-auto ">
            ...
            <li class="group flex gap-1">
              ...
              {cartCount ? (
                <div class="w-4 h-4 -mt-2 -ml-2 rounded-full bg-[#4FBB90] text-[9px] font-bold text-white flex justify-center items-center">
                  {cartCount}
                </div>
              ) : null}
            </li>
            <li class="group flex flex-col -mt-4">
              <div class="w-6 h-4 rounded-3xl bg-[#4FBB90] text-[9px] font-bold text-white flex justify-center items-center">
                ₹0
              </div>
        ...
        <ul class="w-full h-[42px] text-[#999999] text-[14px] font-Quicksand border container px-11 flex flex-wrap justify-center gap-14 items-center mx-auto ">
          <div class="group">
            ...
            <div class="hidden absolute bg-white top-32 -mt-3 pt-8 -ml-5 w-36 flex-col shadow-sm pl-3 z-40 text-black hover:inline-block  group-hover:inline-block ">
          ...
          <div class="group">
            ...
            <div class="hidden absolute bg-white top-32 -mt-3 pt-8 -ml-10 w-52 flex-col shadow-sm pl-3 z-40 text-black hover:inline-block  group-hover:inline-block ">
              <li class="h-10 w-full flex justify-start items-start">
                <Link class="hover:text-[#4FBB90]" to="product">
                  Daily Veggies
                </Link>
        ...
        {searchDivState ? (
          <>
            <div
              ...
              class="fixed top-0 left-0 z-40 bg-opacity-40 bg-black h-screen w-full"
            ></div>
