...
function Vegetables() {
  ...
  return (
    <div className={styles.bestDeals_main}>
        ...
        <h1 className={styles.bestDeals}>VEGETABLES</h1>
        <p>(View All)</p>
        </div>
       ...
       {todos.map((data)=>(
        ...
        <img style={{width:"100",backgroundColor:"#f9f9f9"}} src={data.image} alt="product_image" />
        <div>{data.name}</div>
        <div className={styles.product_each_items_priceButton}>
            <div>
                <div style={{fontSize:"13px",color:"lightslategray",marginTop:"5px"}}>{data.qty}</div>
